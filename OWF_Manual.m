...
x=xlsread('大唐海南CZ3风场人工规划数据.xlsx','D2:I1068');
% x=xlsread('海南东方CZ8风场人工规划数据.xlsx','D2:H504');

%% ***********Objective Function***********
Obj_inv=sum(sum(Cost.*x))*1e4;
Ur_Hours=3000/8760;  % annual hours of OWFs
Pr_ele=300;  % 0.85 ￥/kWh = 850 ￥/MWh
...
ops=sdpsettings('solver', 'gurobi', 'usex0', 0, 'gurobi.MIPGap', 1e-4, 'verbose', 2); % , 'gurobi.MIPFocus', 1
