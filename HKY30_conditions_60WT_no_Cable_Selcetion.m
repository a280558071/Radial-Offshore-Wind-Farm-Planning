...
Coord_WT=xlsread('WT2_Notype.xlsx','B2:C61');
...
% LineCap=[2,3,4,5,6]*12; % Submarine cables: 3×95/185/300/500/800 
% C_lines=[185.4,229.2,280.3,355.5,482.7];
LineCap=80;
C_lines=474.7;
% z_b=[0.246+0.135i 0.1328+0.122i 0.0819+0.113i 0.0614+0.11i 0.039+0.101i 0.03+0.094i];
z=ConsInf(:,4)*(0.03+0.094i)/Zbase; % line impedance unit:p.u., (0.039+0.101i) is the impedance of 3×630 mm2 submarine cables (ohm/km), According to ABB's Cable Catalogue-2016
