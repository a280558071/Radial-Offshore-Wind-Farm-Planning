...
load('42WT_1Sub_LDF_66kV_0112_1505No_Loss&MST_10feeders.mat','s_x');
assign(x,s_x);
...
ops=sdpsettings('solver', 'gurobi', 'usex0', 1, 'gurobi.MIPGap', 1e-4, 'verbose', 2,'gurobi.Heuristics',0.9,'gurobi.TuneTimeLimit',0); % , 'gurobi.MIPFocus', 1
